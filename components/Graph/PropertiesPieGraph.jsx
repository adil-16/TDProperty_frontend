...
import PropertiesDonutChart from "../Charts/PropertiesDonutChart";

const PropertiesPieGraph = () => {
  return (
    <div className="flex flex-col gap-2 items-center shadow-[0px_4px_10px_0px_rgba(0,0,0,0.08)] w-full">
      <div className="flex justify-between items-center w-full px-4 pt-4">
        <p className="text-semibold text-secondary">Property Types</p>
...
export default PropertiesPieGraph;
